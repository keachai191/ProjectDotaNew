    ...
    <div class="container">
        <div class="row"><center>
            <div class="col-lg-12 text-center">
                ...
                <h2>ประเมิณช่างภาพ {{$id->name_user}}</h2>
                ...
                <form method="post" action='updateComment/{{$id->id}}'>
                    ...
                    <div class="col-lg-12">
                        ...
                        @if($id->like == '1')
                            <input type="radio" name="like" value="1" checked > <img src="/assets/img/portfolio/like.jpg"  width="100" height="90"alt="">&nbsp;&nbsp;&nbsp;
                             <input type="radio" name="like" value="2"> <img src="/assets/img/portfolio/unlike.jpg"  width="100" height="90"alt="">
                        @else <input type="radio" name="like" value="1"> <img src="/assets/img/portfolio/like.jpg"  width="100" height="90"alt="">
                         <input type="radio" name="like" value="2" checked> <img src="/assets/img/portfolio/unlike.jpg"  width="100" height="90"alt=""><br>
                            @endif
                        </div><br>
                    <div class="col-lg-12">
